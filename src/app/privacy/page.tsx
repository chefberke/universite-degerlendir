      ...
      <div className="flex-col items-center justify-center px-6">
        ...
        <div className="pt-6">
          <p className="text-[1rem] dark:text-gray-100 font-medium">
            Izmir Üniversiteleri Puanlama uygulaması olarak gizliliğinize büyük önem veriyoruz. İşte bilgilerinizi nasıl
            işlediğimiz:
          </p>
        </div>
        <div className="pt-4 space-y-4">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-400 pt-1">
              Uygulamamızı kullandığınızda kişisel verileriniz yalnızca size hizmet sunmak amacıyla toplanır ve tamamen
